...
public class ParsingTest {
    ...
    public void testUntil() throws Exception{
        Either<String, GenFormula<VariableID>> pubPred = Policy.read("publish(160)");
        System.out.println("a  " + pubPred.toString());
        System.out.println("a right " + pubPred.right().get().toString());
        System.out.println("a atoms " + pubPred.right().get().atoms());
        System.out.println("a free " + pubPred.right().get().freeVariables());
